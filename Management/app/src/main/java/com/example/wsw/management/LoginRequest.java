...
public class LoginRequest extends StringRequest{
    ...
    final static private String URL = "http://pplesb2015.ivyro.net/Login.php";//파일을 매칭
    private Map<String, String> parameters; //Map 추가

    //생성자 만들기
    public LoginRequest(String userID, String userPassword, Response.Listener<String> listener){ //Response 관련한 변수 추가
